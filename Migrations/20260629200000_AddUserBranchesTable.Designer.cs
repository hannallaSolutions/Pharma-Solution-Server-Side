...
namespace SearchTool_ServerSide.Migrations
{
    ...
    [Migration("20260629200000_AddUserBranchesTable")]
    partial class AddUserBranchesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SearchTool_ServerSide.Models.Disease", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SearchTool_ServerSide.Models.DrugAlternativeStatus", b =>
                {
                    ...
                    b.HasKey("SourceDrugNDC", "TargetDrugNDC", "ClassInfoId");
            ...
            modelBuilder.Entity("SearchTool_ServerSide.Models.MainCompanyFeatureSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("SelectedOptionKeysJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("MainCompanyId", "FeatureKey")
                        .IsUnique();

                    b.ToTable("MainCompanyFeatureSettings");
                });
            ...
            modelBuilder.Entity("SearchTool_ServerSide.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SearchTool_ServerSide.Models.SectionEntry", b =>
                {
                    ...
                    b.Property<int>("FeedbackFormEntryId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SearchTool_ServerSide.Models.UserBranch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SearchTool_ServerSide.Models.DrugAlternativeReport", b =>
                {
                    ...
                    b.HasOne("SearchTool_ServerSide.Models.DrugAlternativeStatus", "DrugAlternativeStatus")
                        .WithMany("Reports")
                        .HasForeignKey("SourceDrugNDC", "TargetDrugNDC", "ClassInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DrugAlternativeStatus");
            ...
            modelBuilder.Entity("SearchTool_ServerSide.Models.DrugAlternativeStatus", b =>
                {
                    ...
                    b.HasOne("SearchTool_ServerSide.Models.Drug", "SourceDrug")
                        .WithMany()
                        .HasForeignKey("SourceDrugNDC")
                        .HasPrincipalKey("NDC")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SearchTool_ServerSide.Models.Drug", "TargetDrug")
                        .WithMany()
                        .HasForeignKey("TargetDrugNDC")
                        .HasPrincipalKey("NDC")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SearchTool_ServerSide.Models.QuestionEntry", b =>
                {
                    b.HasOne("SearchTool_ServerSide.Models.SectionEntry", "Section")
                        .WithMany("Questions")
                        .HasForeignKey("SectionEntryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SearchTool_ServerSide.Models.RolePermission", b =>
                {
                    b.HasOne("SearchTool_ServerSide.Models.Permission", "Permission")
            ...
            modelBuilder.Entity("SearchTool_ServerSide.Models.SearchDrugDetailsLogs", b =>
                {
                    b.HasOne("SearchTool_ServerSide.Models.Drug", "Drug")
                        .WithMany("SearchDrugDetailsLogs")
                        .HasForeignKey("NDC")
                        .HasPrincipalKey("NDC")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SearchTool_ServerSide.Models.SectionEntry", b =>
                {
                    b.HasOne("SearchTool_ServerSide.Models.FeedbackFormEntry", "FeedbackForm")
                        .WithMany("Sections")
                        .HasForeignKey("FeedbackFormEntryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
