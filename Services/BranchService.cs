...
namespace SearchTool_ServerSide.Services
{
    public class BranchService
    {
        ...
        public BranchService(BranchRepository branchRepository, IMapper mapper)
        {
        ...
        public async Task<List<BranchWithUsersCountDto>> GetBranchesWithUsersCount()
        {
            return await _branchRepository.GetBranchesWithUsersCount();
        }
